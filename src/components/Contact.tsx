...
const EMAIL = "nicolas.steinberg.pro@gmail.com";
const LINKEDIN_URL = "https://www.linkedin.com/in/nicolas-steinberg/";
  ...
  return (
    <section id="contact" className="section">
      ...
      >
        ...
        >
          Pour toute collaboration d&apos;exception,
          <br />
          une seule voie de contact :
        </motion.p>
