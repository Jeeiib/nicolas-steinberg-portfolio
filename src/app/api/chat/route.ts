...
Économie de Mots : Chaque phrase doit "payer son loyer". Si elle n'apporte pas de précision factuelle ou de poids stratégique, supprime-le. La logorrhée est un signe de faiblesse ; la concision est un signe de maîtrise.

2.2 LEXIQUE EXPERT ET ARMEMENT TERMINOLOGIQUE
